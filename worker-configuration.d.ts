/* eslint-disable */
// Generated by Wrangler for the self-hosted `wrangler.jsonc` binding contract with strict vars disabled.
...
interface __BaseEnv_Env {
	...
	ANALYTICS_QUEUE_3: Queue;
	BILLING_QUEUE: Queue;
	EMAIL_QUEUE: Queue;
	SOCIAL_PUBLISH_QUEUE: Queue;
	SOCIAL_INSIGHTS_QUEUE: Queue;
	...
	ASSETS: Fetcher;
	APP_ENV: string;
	FOUNDER_ADMIN_EMAILS: string;
	VITE_FEATUREBASE_APP_ID: string;
	COMMERCE_PAYMENT_PROVIDER: string;
	POLAR_ENVIRONMENT: string;
	PAYPAL_ENVIRONMENT: string;
	SOCIAL_PROVIDER_MODE: string;
	SOCIAL_LINKEDIN_PROVIDER_MODE: string;
	SOCIAL_TWITTER_PROVIDER_MODE: string;
	SOCIAL_REDDIT_PROVIDER_MODE: string;
	SOCIAL_TIKTOK_PROVIDER_MODE: string;
	INSTAGRAM_AUTO_DM_PROVIDER_MODE: string;
	RAZORPAY_ROUTE_ENABLED: string;
	CUSTOM_DOMAINS_ENABLED: string;
	PUBLIC_PAGE_CACHE_TTL_SECONDS: string;
	...
	META_INSTAGRAM_ACCESS_LEVEL: string;
	...
	DODO_STORE_MONTHLY_PRODUCT_ID: string;
	DODO_STORE_YEARLY_PRODUCT_ID: string;
	DODO_CREATOR_MONTHLY_PRODUCT_ID: string;
	DODO_CREATOR_YEARLY_PRODUCT_ID: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.output/server/worker");
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "FOUNDER_ADMIN_EMAILS" | "VITE_FEATUREBASE_APP_ID" | "COMMERCE_PAYMENT_PROVIDER" | "POLAR_ENVIRONMENT" | "PAYPAL_ENVIRONMENT" | "SOCIAL_PROVIDER_MODE" | "SOCIAL_LINKEDIN_PROVIDER_MODE" | "SOCIAL_TWITTER_PROVIDER_MODE" | "SOCIAL_REDDIT_PROVIDER_MODE" | "SOCIAL_TIKTOK_PROVIDER_MODE" | "INSTAGRAM_AUTO_DM_PROVIDER_MODE" | "RAZORPAY_ROUTE_ENABLED" | "CUSTOM_DOMAINS_ENABLED" | "PUBLIC_PAGE_CACHE_TTL_SECONDS" | "EMAIL_DELIVERY_MODE" | "RESEND_FROM_EMAIL" | "RESEND_REPLY_TO" | "RESEND_TEST_RECIPIENT" | "META_INSTAGRAM_APP_ID" | "META_INSTAGRAM_REDIRECT_URI" | "META_GRAPH_API_VERSION" | "META_INSTAGRAM_ACCESS_LEVEL" | "GOOGLE_YOUTUBE_CLIENT_ID" | "SUPABASE_PROJECT_ID" | "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SERVICE_ROLE_KEY" | "VITE_SUPABASE_PROJECT_ID" | "VITE_SUPABASE_URL" | "VITE_SUPABASE_PUBLISHABLE_KEY" | "DODO_PAYMENTS_API_KEY" | "DODO_PAYMENTS_ENVIRONMENT" | "DODO_PAYMENTS_WEBHOOK_KEY" | "DODO_STORE_MONTHLY_PRODUCT_ID" | "DODO_STORE_YEARLY_PRODUCT_ID" | "DODO_CREATOR_MONTHLY_PRODUCT_ID" | "DODO_CREATOR_YEARLY_PRODUCT_ID" | "VITE_PUBLIC_POSTHOG_KEY" | "VITE_PUBLIC_POSTHOG_HOST" | "POSTHOG_PROJECT_KEY" | "POSTHOG_HOST" | "POSTHOG_PROJECT_ID" | "POSTHOG_PERSONAL_API_KEY" | "VITE_APP_URL" | "VITE_PUBLIC_URL">> {}
}
