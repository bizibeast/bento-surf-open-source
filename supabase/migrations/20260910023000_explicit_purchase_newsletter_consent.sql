-- Purchases do not grant newsletter consent. Existing unsubscribe choices remain respected.
...
begin
  if order_row.metadata->>'newsletter_opt_in' is distinct from 'true' then
    return;
  end if;
